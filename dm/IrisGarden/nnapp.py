...
for i in norm_garden:
    if o == 0 or o == 31 or o == 62:
        print "{} : {} : {}".format(o+1, i, class_arr[o])
    o += 1
...
def k_means():
    print setosa
    k_centroids = norm_garden[0:3]
    # k_centroids[0] = norm_garden[7]
    # k_centroids[1] = norm_garden[5]
    # k_centroids[2] = norm_garden[51]
    ...
    # if c0:
        #     c_centroids[0] = get_centroid(c0)
        # if c1:
        #     c_centroids[1] = get_centroid(c1)
        # if c2:
        #     c_centroids[2] = get_centroid(c2)
